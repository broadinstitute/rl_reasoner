...
from swagger_server.models.credentials import Credentials  # noqa: F401,E501
...
class RemoteKnowledgeGraph(Model):
    ...
    """
    def __init__(self, url: str=None, credentials: List[Credentials]=None, protocol: str='neo4j'):  # noqa: E501
    ...
    @property
    def credentials(self) -> List[Credentials]:
    ...
    @credentials.setter
    def credentials(self, credentials: List[Credentials]):
